...
/**
 * Description of UsageStatisticsByTitles
 *
 * @author bgarcia
 */
...
AND t.titleID in (SELECT t2.titleID FROM Title t2 LEFT JOIN TitleIdentifier ti2 ON ti2.titleID = t2.titleID WHERE t2.titleID != '' {$this->addWhere[1]})
